const CACHE='nai-mobile-v1-4-20260918';
const ASSETS=['./','./index.html','./style.css?v=14','./app.js?v=14','./manifest.webmanifest','./assets/nai_mobile_scene.jpg','./icons/icon-192.png','./icons/icon-512.png'];
