const CACHE='nai-mobile-v1-2-20260918';
const ASSETS=['./','./index.html','./style.css?v=12','./app.js?v=12','./manifest.webmanifest','./assets/nai_mobile_scene.jpg','./icons/icon-192.png','./icons/icon-512.png'];
