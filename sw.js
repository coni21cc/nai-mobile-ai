const CACHE='nai-mobile-v1-3-20260918';
const ASSETS=['./','./index.html','./style.css?v=13','./app.js?v=13','./manifest.webmanifest','./assets/nai_mobile_scene.jpg','./icons/icon-192.png','./icons/icon-512.png'];
