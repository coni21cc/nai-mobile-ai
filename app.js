...
const speech=$('#speech'),userLine=$('#userLine'),input=$('#chatInput');
...
$('#shadowToggle').addEventListener('change',e=>speech.style.textShadow=e.target.checked?'0 2px 14px rgba(0,0,0,.95),0 1px 2px rgba(0,0,0,.95)':'none');
